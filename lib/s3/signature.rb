module S3
  ...
  # This class was taken from https://github.com/qoobaa/s3 and modified slightly to fit our
  # needs.
  #
  ...
  class Signature
    ...
    def self.generate(options)
      ...
      options.merge!(:headers => request.headers, :method => request.method, :resource => request.path)
